...
try:
	...
	to = raw_input(bcolors.OKGREEN + 'Correo de la victima: ' + bcolors.ENDC)
	subject = raw_input(bcolors.OKGREEN + 'Sujeto (Opcional): ' + bcolors.ENDC)
	body = raw_input(bcolors.OKGREEN + 'Mensaje: ' + bcolors.ENDC)
	nomes = input(bcolors.OKGREEN + 'Numero de emails para enviar: ' + bcolors.ENDC)
	no = 0
	message = 'From: ' + user + '\nSubject: ' + subject + '\n' + body
...
#Hotmail/Outlook
	...
	print 'Funciona solo en Gmail, Yahoo, Outlook y Hotmail.'
	sys.exit()
